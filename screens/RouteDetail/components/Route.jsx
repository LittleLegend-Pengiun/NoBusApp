...
function Route({ title, time, isFirst, isLast, reverse }) {
  const iconName = isFirst? "source-commit-start" : isLast? "source-commit-end" : "source-commit";
  return (
    <View className="flex-row -mt-1 -mb-2 space-x-2 items-center px-1 mx-1 w-full">
        <MaterialCommunityIcons name={iconName} size={40} color={reverse? "#32B778": "#422268"} />
